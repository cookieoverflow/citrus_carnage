class Level
  ...
  def run(args, game)
    ...
    # if mins > 5
    #   klass = self.enemy_manager.spawn_groups[self.enemy_manager.current_spawn_group].sample
    #   if args.state.secs % (5 * 60) == 0
    #     self.enemy_manager.spawn_enemy(klass, 5)
    #   elsif args.state.secs % (5 * 60 + 15) == 0
    #     self.enemy_manager.spawn_enemy(klass, 5)
    #   elsif args.state.secs % (5 * 60 + 30) == 0
    #     self.enemy_manager.spawn_enemy(klass, 5)
    #   elsif args.state.secs % (5 * 60 + 45) == 0
    #     self.enemy_manager.spawn_enemy(klass, 5)
    #   end
    # end
